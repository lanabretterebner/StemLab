...
if (-not (Test-Path -LiteralPath $Python -PathType Leaf)) {
    Write-Host "Creating the FI-STEM Python $($BackendConfiguration.Python) $($BackendConfiguration.Label) environment..." -ForegroundColor Cyan
...
Install-FIStemTorchBackend $Python $BackendConfiguration
