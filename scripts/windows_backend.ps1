function Get-FIStemBackendConfiguration([string]$Backend) {
    switch ($Backend.ToLowerInvariant()) {
        ...
        default { throw "Unsupported FI-STEM Windows backend: $Backend" }
    }
}

function Install-FIStemTorchBackend([string]$Python, [hashtable]$Configuration) {
